...
public class OvalCheckbox extends RectCheckbox {
         ...
         */
        public OvalCheckbox(EngineContext context, int x, int y, int width, int height) {
        ...
        public OvalCheckbox(EngineContext context, Point topLeft, Point bottomRight) {
        ...
        public OvalCheckbox(EngineContext context, Point center, int width, int height) {
         ...
         */
        public OvalCheckbox(EngineContext context, Point center, int radius) {
